      ...
      <div class="row">
        <div class="col col-md-3">
          <div class="form-group">
            ...
            <select class="form-control " id="report_to_district" style="width: 100%;" tabindex="-1" aria-hidden="true">
        ...
        <div class="col col-md-3">
          <div class="form-group">
            ...
            <select class="form-control  inputDisabled " id="report_to_area" style="width: 100%;" tabindex="-1" aria-hidden="true" disabled>
