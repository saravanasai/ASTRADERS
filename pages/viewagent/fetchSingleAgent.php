...
if (isset($_POST["id"])) {
  ...
  foreach ($singleAgentDeatail as $singleAgent) {
    ...
    <div class="card-body">
      ...
      <div class="form-group">
      <label for="agentPasswordUpdate">AGENT NEW PASSWORD</label>
      <input type="text" class="form-control" id="agentPasswordUpdate" name="agentPasswordUpdate" placeholder="Agent New Password" value="">
    </div>
      <div class="form-group">
